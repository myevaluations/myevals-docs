...
<DependentsPanel module="PatientLog" />
...
This module maps to the **PTL\_** table prefix with **38 database tables**.

| Metric | Value |
|--------|-------|
| Tables | 38 |
| With Primary Key | 32 (84%) |

Browse the full table reference with expandable details, FK relationships, and Mermaid ER diagrams:

- [**Patient Logs Database Tables**](/docs/database/modules/patient-logs) — 38 tables with schema detail and migration notes
