...
This module maps to the **BSN\_** table prefix with **111 database tables**.

| Metric | Value |
|--------|-------|
| Tables | 111 |
| With Primary Key | 100 (90%) |

Browse the full table reference with expandable details, FK relationships, and Mermaid ER diagrams:

- [**Nursing Database Tables**](/docs/database/modules/nursing) — 111 tables with schema detail and migration notes
