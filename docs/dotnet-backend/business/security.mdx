...
This module maps to the **SEC\_** table prefix with **346 database tables**.

| Metric | Value |
|--------|-------|
| Tables | 346 |
| With Primary Key | 264 (76%) |

Browse the full table reference with expandable details, FK relationships, and Mermaid ER diagrams:

- [**Security Database Tables**](/docs/database/modules/security) — 346 tables with schema detail and migration notes
