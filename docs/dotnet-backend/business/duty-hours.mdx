...
<DependentsPanel module="DutyHours" />
...
This module maps to the **DH\_** table prefix with **182 database tables**.

| Metric | Value |
|--------|-------|
| Tables | 182 |
| With Primary Key | 117 (64%) |

Browse the full table reference with expandable details, FK relationships, and Mermaid ER diagrams:

- [**Duty Hours Database Tables**](/docs/database/modules/duty-hours) — 182 tables with schema detail and migration notes
