...
Portfolio business module providing portfolio functionality for the MyEvaluations platform.
...
<FileReference
  ...
  },
  {
    ...
    "businessPurpose": "Orchestrates the display, creation, and editing of every type of portfolio document in MyPortfolio — from medical licenses and training contracts to QI projects — by initializing the appropriate form controls, populating dropdowns from lookup tables, and managing section-specific field visibility rules.",
    "keyMethods": [
