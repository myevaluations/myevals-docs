...
<FileReference
  ...
  directoryOverview="Business layer for Amion/QGenda/Tangier schedule APIs and timesheet management."
  keyWorkflows={["Amion schedule sync","QGenda API calls","Tangier schedule import","Timesheet submission"]}
/>
