---
title: "Business.LearningAssignment Files"
sidebar_label: "Business.LearningAssignment"
description: "Per-file reference for Business.LearningAssignment (12 files)"
---

import FileReference from '@site/src/components/FileReference';

# Business.LearningAssignment File Reference

**12 files** · **4,323 lines** · Generated 2/21/2026

LearningAssignment business module providing learningassignment functionality for the MyEvaluations platform.
