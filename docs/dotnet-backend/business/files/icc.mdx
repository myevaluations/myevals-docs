---
title: "Business.ICC Files"
sidebar_label: "Business.ICC"
description: "Per-file reference for Business.ICC (2 files)"
---

import FileReference from '@site/src/components/FileReference';

# Business.ICC File Reference

**2 files** · **432 lines** · Generated 2/21/2026

ICC business module providing icc functionality for the MyEvaluations platform.
...
<FileReference
  files={[
  {
    ...
    "businessPurpose": "Calculates ICC reliability statistics for evaluation scoring profiles, enabling program directors to assess inter-rater agreement for clinical evaluations — a key accreditation and quality-assurance metric in GME programs.",
    "keyMethods": [
