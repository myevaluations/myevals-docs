---
title: "Business.AdobeSign Files"
sidebar_label: "Business.AdobeSign"
description: "Per-file reference for Business.AdobeSign (8 files)"
---

import FileReference from '@site/src/components/FileReference';

# Business.AdobeSign File Reference

**8 files** · **2,732 lines** · Generated 2/21/2026

AdobeSign business module providing adobesign functionality for the MyEvaluations platform.
