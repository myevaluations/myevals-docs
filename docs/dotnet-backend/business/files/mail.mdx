---
title: "Business.Mail Files"
sidebar_label: "Business.Mail"
description: "Per-file reference for Business.Mail (6 files)"
---

import FileReference from '@site/src/components/FileReference';

# Business.Mail File Reference

**6 files** · **15,427 lines** · Generated 2/21/2026

Mail business module providing mail functionality for the MyEvaluations platform.
