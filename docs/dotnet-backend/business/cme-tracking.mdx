...
This module maps to the **CME\_** table prefix with **61 database tables**.

| Metric | Value |
|--------|-------|
| Tables | 61 |
| With Primary Key | 50 (82%) |

Browse the full table reference with expandable details, FK relationships, and Mermaid ER diagrams:

- [**CME Credits Database Tables**](/docs/database/modules/cme-credits) — 61 tables with schema detail and migration notes
