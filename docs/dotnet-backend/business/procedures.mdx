...
<DependentsPanel module="Procedures" />
...
This module maps to the **PRC\_** table prefix with **107 database tables**.

| Metric | Value |
|--------|-------|
| Tables | 107 |
| With Primary Key | 63 (59%) |

Browse the full table reference with expandable details, FK relationships, and Mermaid ER diagrams:

- [**Procedures Database Tables**](/docs/database/modules/procedures) — 107 tables with schema detail and migration notes
