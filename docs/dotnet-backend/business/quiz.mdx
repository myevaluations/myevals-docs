...
This module maps to the **QUIZ\_** table prefix with **25 database tables**.

| Metric | Value |
|--------|-------|
| Tables | 25 |
| With Primary Key | 14 (56%) |

Browse the full table reference with expandable details, FK relationships, and Mermaid ER diagrams:

- [**Quizzes Database Tables**](/docs/database/modules/quizzes) — 25 tables with schema detail and migration notes
