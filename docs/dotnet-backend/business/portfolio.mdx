...
<DependentsPanel module="Portfolio" />
...
This module maps to the **PF\_** table prefix with **67 database tables**.

| Metric | Value |
|--------|-------|
| Tables | 67 |
| With Primary Key | 54 (81%) |

Browse the full table reference with expandable details, FK relationships, and Mermaid ER diagrams:

- [**Portfolio Database Tables**](/docs/database/modules/portfolio) — 67 tables with schema detail and migration notes
