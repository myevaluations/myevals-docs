...
<DependentsPanel module="LearningAssignment" />
...
This module maps to the **LA\_** table prefix with **12 database tables**.

| Metric | Value |
|--------|-------|
| Tables | 12 |
| With Primary Key | 12 (100%) |

Browse the full table reference with expandable details, FK relationships, and Mermaid ER diagrams:

- [**Learning Activities Database Tables**](/docs/database/modules/learning-activities) — 12 tables with schema detail and migration notes
