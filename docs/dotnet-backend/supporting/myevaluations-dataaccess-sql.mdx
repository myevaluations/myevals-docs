---
title: "MyEvaluations.DataAccess.SQL Files"
sidebar_label: "MyEvaluations.DataAccess.SQL"
description: "Per-file reference for MyEvaluations.DataAccess.SQL (4 files)"
---

import FileReference from '@site/src/components/FileReference';

# MyEvaluations.DataAccess.SQL File Reference

> **4 files** | **561 lines** | Generated 2/20/2026
...
<FileReference
  ...
  keyWorkflows={["SQL command building with CustomCommand parameter management","Database query execution (DataTable, DataSet, DataReader, Scalar, NonQuery)","Transaction management with parent-child command patterns","Error logging with ApplicationCustomErrorEvent for health monitoring"]}
/>
