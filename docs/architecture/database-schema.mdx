...
For interactive schema exploration, per-module table references, and SP reconciliation, see the **[Database Schema](/docs/database/overview)** section — 2,284 tables across 23 modules with Mermaid ER diagrams and expandable detail.
:::
