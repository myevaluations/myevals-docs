...
The SQL Server database is the primary data store, shared between the .NET and Node.js backends. It has evolved over 25+ years and contains hundreds of tables.

### Core Entity Groups

<!-- AUTO-GENERATED: Table counts and column details will be enriched from database analysis scripts -->
...
<!-- AUTO-GENERATED: Specific table names and columns will be enriched from Node.js backend MikroORM entity analysis -->
...
The .NET backend uses **1000+ stored procedures** for all data access. These are the primary API contract between the application and database.

### Stored Procedure Categories

<!-- AUTO-GENERATED: Specific stored procedure counts per category will be enriched from parse-dotnet-sprocs script -->

| Category | Prefix Convention | Example | Estimated Count |
|----------|-------------------|---------|----------------|
| User Management | `usp_User*` | `usp_UserGetByID`, `usp_UserInsert` | ~50 |
| Evaluations | `usp_Eval*` | `usp_EvalGetByTemplate`, `usp_EvalSave` | ~100 |
| Duty Hours | `usp_DutyHour*` | `usp_DutyHourInsert`, `usp_DutyHourGetWeekly` | ~40 |
| Patient Log | `usp_PatientLog*` | `usp_PatientLogInsert`, `usp_PatientLogSearch` | ~30 |
| Procedures | `usp_Procedure*` | `usp_ProcedureInsert`, `usp_ProcedureGetByUser` | ~25 |
| CME Tracking | `usp_CME*` | `usp_CMECreditInsert`, `usp_CMEReport` | ~30 |
| Authentication | `usp_Auth*`, `Get*` | `GetLoggedInUserInfo`, `GetPrivilegesForRole` | ~20 |
| Scheduling | `usp_Schedule*` | `usp_ScheduleRotation`, `usp_ScheduleGetByDate` | ~35 |
| Reporting | `usp_Report*`, `usp_Rpt*` | `usp_ReportEvalSummary` | ~80 |
| Administration | `usp_Admin*` | `usp_AdminGetSettings`, `usp_AdminUpdateConfig` | ~40 |
| Lookup/Config | `usp_Lookup*` | `usp_LookupGetByCategory` | ~20 |
...
<!-- AUTO-GENERATED: Specific backup schedules and retention policies will be documented from infrastructure analysis -->
...
<!-- AUTO-GENERATED: Index statistics and fragmentation reports will be enriched from database analysis -->
